...
- Palpites bloqueados por jogo: o Worker rejeita envios cujo `utc_date` já passou (comparação direta em UTC). `cutoff_at` permanece para expiração/geração de token e exibição.
